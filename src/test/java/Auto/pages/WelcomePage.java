...
public class WelcomePage {
    ...
    final static String TITLE = "Home Page View Detailed Report";
    final static String HEADING = "Heatmaps";
    WebDriver driver;
    String xpathHeading = "//h1";
    String xpathLink = "//ul/li/a[text()='**link**']";
    By viewheatmapButton = By.xpath("//button[contains(text(),'View Heatmap')]");
    ...
    {
        driver.findElement(viewheatmapButton).click();
    }
